...
<div class="wrapper d-flex flex-column min-vh-100 bg-light">
          ...
          <div class="dropdown-menu dropdown-menu-end pt-0">
            ...
            <div class="dropdown-header bg-light py-2">
              ...
              <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                ...
                </svg> Lock Account</a><a class="dropdown-item" href="../includes/logout.php">
                <svg class="icon me-2">
                  <use xlink:href=""></use>
                </svg> Logout</a>
          </div>
  ...
  <div class="body flex-grow-1 px-3 sec_three">
    <div class="container-lg sec_three">
      <div class="row">
        <div class="col-sm-6 col-lg-4 sec_three">
